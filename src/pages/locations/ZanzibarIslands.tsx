...
const ZanzibarIslands = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        <img src={zanzibarHeroImage} alt="Zanzibar Islands" className="absolute inset-0 w-full h-full object-cover object-center" />
        
        {/* Black Overlay */}
        <div className="absolute inset-0 bg-black/25" />

        <div className="relative z-10 text-center text-white px-4">
          <p className="text-2xl md:text-3xl italic font-light mb-2">​explore</p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <ChevronDown className="w-10 h-10 text-white transition-all duration-500 hover:translate-y-2 cursor-pointer" strokeWidth={1.5} />
        </div>
      </section>
