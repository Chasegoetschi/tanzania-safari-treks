...
const CulturalExperiencesDetail = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <img src={culturalExperiencesHeroImage} alt="Cultural and local experiences with traditional crafts" className="absolute inset-0 w-full h-full object-cover object-center" />
        
        {/* Black Overlay */}
        <div className="absolute inset-0 bg-black/40" />

        <div className="relative z-10 text-center text-white px-4">
          <p className="text-2xl md:text-3xl italic font-light mb-2">extraordinary</p>
