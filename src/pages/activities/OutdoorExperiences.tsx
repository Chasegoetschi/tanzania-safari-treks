...
const OutdoorExperiences = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <img src={activitiesHeroImage} alt="Exhilarating Activities" className="absolute inset-0 w-full h-full object-cover object-center" />
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="space-y-6">
            {outdoorTrips.map((trip, index) => <div key={index} onClick={() => window.location.href = trip.link} className="group relative h-[200px] overflow-hidden rounded-xl shadow-lg cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
