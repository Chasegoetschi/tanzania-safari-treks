        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <DropdownMenu open={openSafaris} onOpenChange={setOpenSafaris}>
              <div 
                onMouseEnter={() => setOpenSafaris(true)} 
                onMouseLeave={() => setOpenSafaris(false)}
              >
            ...
            <DropdownMenu open={openActivities} onOpenChange={setOpenActivities}>
              <div 
                onMouseEnter={() => setOpenActivities(true)} 
                onMouseLeave={() => setOpenActivities(false)}
              >
                <DropdownMenuTrigger 
                  asChild
                  className={`text-sm font-medium transition-colors uppercase tracking-wider cursor-pointer ${
                    isHomePage && !isScrolled 
                      ? 'text-white/80 hover:text-white' 
                      : 'text-foreground/70 hover:text-foreground'
                  }`}
        ...
        {isOpen && (
          <div className="lg:hidden pb-6 space-y-4 bg-white">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white z-[100]">
                <DropdownMenuItem asChild>
                  <Link to="/activities/hiking-detail" onClick={() => { setIsOpen(false); window.scrollTo(0, 0); }} className="cursor-pointer">
                    Hiking Adventures
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to="/activities/cultural-detail" onClick={() => { setIsOpen(false); window.scrollTo(0, 0); }} className="cursor-pointer">
                    Cultural Experiences
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to="/activities/outdoor-detail" onClick={() => { setIsOpen(false); window.scrollTo(0, 0); }} className="cursor-pointer">
                    Outdoor Experiences
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
